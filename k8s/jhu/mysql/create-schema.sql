...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`GRANT_APPLICATION` (
  ...
  `app_planned_submission_date` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`GRANT_AWARD` (
  ...
  PRIMARY KEY (`grant_award_id`, `funding_organization_id`),
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (
  ...
  `funding_organization_id` INT NOT NULL,
  PRIMARY KEY (`grant_disbursement_id`, `grant_award_id`, `funding_organization_id`),
  INDEX `fk_GRANT_DISBURSEMENT_GRANT_AWARD1_idx` (`grant_award_id` ASC, `funding_organization_id` ASC) VISIBLE,
  UNIQUE INDEX `grant_disbursement_id_UNIQUE` (`grant_disbursement_id` ASC) VISIBLE,
  CONSTRAINT `fk_GRANT_DISBURSEMENT_GRANT_AWARD1`
    FOREIGN KEY (`grant_award_id` , `funding_organization_id`)
    REFERENCES `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id` , `funding_organization_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`CONTRACT` (
  ...
  `funding_organization_id` INT NULL,
  UNIQUE INDEX `contract_id_UNIQUE` (`contract_id` ASC) VISIBLE,
  INDEX `fk_CONTRACT_GRANT_AWARD1_idx` (`grant_award_id` ASC, `funding_organization_id` ASC) VISIBLE,
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (1, 350000, 'awarded', '2020-10-11 00:00:00', '2020-10-10 00:00:00', 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (2, 90000, 'awarded', '2023-12-17 00:00:00', '2023-12-17 00:00:00', 2);
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (3, 75000, 'todo', NULL, '2024-02-16 00:00:00', 3);
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (4, 500000, 'todo', NULL, '2024-05-20 00:00:00', 5);
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (6, 350000, 'awarded', '2023-10-11 00:00:00', '2023-10-10 00:00:00', 6);
INSERT INTO `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`, `app_fund_requested`, `app_status`, `app_actual_submission_date`, `app_planned_submission_date`, `grant_opportunity_id`) VALUES (7, 100000, 'submitted', '2023-11-01 00:00:00', '2023-11-01 00:00:00', 7);
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (1, '2021-01-01 00:00:00', 116666.66, 1, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (2, '2022-01-01 00:00:00', 116666.66, 1, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (3, '2023-01-01 00:00:00', 116666.66, 1, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (4, '2024-01-01 00:00:00', 116666.66, 2, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (5, '2025-01-01 00:00:00', 116666.66, 2, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (6, '2026-01-01 00:00:00', 116666.66, 2, 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (7, '2023-02-01 00:00:00', 45000, 3, 2);
INSERT INTO `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (`grant_disbursement_id`, `grant_disbursement_date`, `grant_disbursement_amount`, `grant_award_id`, `funding_organization_id`) VALUES (8, '2024-04-01 00:00:00', 45000, 3, 2);
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`CONTRACT` (`contract_id`, `start_date`, `end_date`, `grant_award_id`, `funding_organization_id`) VALUES (1, '2021-01-01 00:00:00', '2024-01-01 00:00:00', 1, 1);
INSERT INTO `grant-and-program-tracking`.`CONTRACT` (`contract_id`, `start_date`, `end_date`, `grant_award_id`, `funding_organization_id`) VALUES (2, '2024-01-01 00:00:00', '2027-01-01 00:00:00', 2, 1);
INSERT INTO `grant-and-program-tracking`.`CONTRACT` (`contract_id`, `start_date`, `end_date`, `grant_award_id`, `funding_organization_id`) VALUES (3, NULL, NULL, 3, 2);
