...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`GRANT_AWARD` (
  ...
  INDEX `fk_GRANT_AWARD_GRANT_APPLICATION1_idx` (`grant_application_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_GRANT_AWARD_GRANT_APPLICATION1`
    FOREIGN KEY (`grant_application_id`)
    REFERENCES `grant-and-program-tracking`.`GRANT_APPLICATION` (`grant_application_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (
  ...
  PRIMARY KEY (`app_deliverable_id`),
  UNIQUE INDEX `app_deliverable_id_UNIQUE` (`app_deliverable_id` ASC) VISIBLE,
  INDEX `fk_APPLICATION_DELIVERABLE_GRANT_APPLICATION2_idx` (`grant_application_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`PROGRAM_EXPENDITURE` (
  ...
  `program_expenditure_date` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (
  ...
  `grant_application_id` INT NOT NULL,
  PRIMARY KEY (`stakeholder_id`, `grant_application_id`),
  INDEX `fk_APPLICATION_INTERNAL_STAKEHOLDER_INTERNAL_STAKEHOLDER1_idx` (`stakeholder_id` ASC) VISIBLE,
  INDEX `fk_APPLICATION_STAKEHOLDER_GRANT_APPLICATION1_idx` (`grant_application_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`GRANT_DISBURSEMENT` (
  ...
  PRIMARY KEY (`grant_disbursement_id`),
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`APP_DELIVERABLE_CHANGE_HISTORY` (
  ...
  INDEX `fk_APP_DELIVERABLE_CHANGE_HISTORY_APPLICATION_DELIVERABLE1_idx` (`app_deliverable_id` ASC) VISIBLE,
  CONSTRAINT `fk_APP_DELIVERABLE_CHANGE_HISTORY_APPLICATION_DELIVERABLE1`
    FOREIGN KEY (`app_deliverable_id`)
    REFERENCES `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`PROGRAM_DELIVERABLE` (
  ...
  PRIMARY KEY (`program_deliverable_id`),
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`PROGRAM_DELIVERABLE_CHANGE_HISTORY` (
  ...
  PRIMARY KEY (`change_id`),
  UNIQUE INDEX `change_id_UNIQUE` (`change_id` ASC) VISIBLE,
  INDEX `fk_PROGRAM_DELIVERABLE_CHANGE_HISTORY_PROGRAM_DELIVERABLE1_idx` (`program_deliverable_id` ASC) VISIBLE,
  CONSTRAINT `fk_PROGRAM_DELIVERABLE_CHANGE_HISTORY_PROGRAM_DELIVERABLE1`
    FOREIGN KEY (`program_deliverable_id`)
    REFERENCES `grant-and-program-tracking`.`PROGRAM_DELIVERABLE` (`program_deliverable_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `grant-and-program-tracking`.`APP_CHANGE_HISTORY` (
  ...
  `grant_application_id` INT NOT NULL,
  PRIMARY KEY (`change_id`),
  INDEX `fk_APP_CHANGE_HISTORY_GRANT_APPLICATION1_idx` (`grant_application_id` ASC) VISIBLE,
  UNIQUE INDEX `change_id_UNIQUE` (`change_id` ASC) VISIBLE,
...
BEGIN
    ...
    SELECT 
		fo.funding_organization_id INTO fundOrgId
	FROM 
		GRANT_APPLICATION ga
	INNER JOIN 
		GRANT_OPPORTUNITY go ON ga.grant_opportunity_id = go.grant_opportunity_id
	INNER JOIN 
		FUNDING_ORGANIZATION fo ON go.funding_organization_id = fo.funding_organization_id
	WHERE 
		ga.grant_application_id = 7;
...
BEGIN
    ...
    INSERT INTO APP_CHANGE_HISTORY (
		grant_application_id, change_timestamp,
...
BEGIN
    ...
    SELECT grant_opportunity_id INTO opportunityId
    FROM GRANT_APPLICATION
    WHERE grant_application_id = NEW.grant_application_id;
    
    IF CheckSubmissionDate(opportunityId, NEW.app_deliverable_planned_completion_date) = 0 THEN
        SIGNAL SQLSTATE '45000'
...
BEGIN
	...
	INSERT INTO APP_DELIVERABLE_CHANGE_HISTORY (app_deliverable_id, change_timestamp, row_snapshot_serialized, changed_by, change_description)
	VALUES (
...
BEGIN
	...
	INSERT INTO PROGRAM_DELIVERABLE_CHANGE_HISTORY (program_deliverable_id, change_timestamp, row_snapshot_serialized, changed_by, change_description)
	VALUES (
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (1, 1, 350000, '2020-11-03 00:00:00', 1);
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (2, 1, 350000, '2023-11-03 00:00:00', 6);
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (3, 2, 90000, '2023-12-29 00:00:00', 2);
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (4, 3, 25000, '2023-09-02 00:00:00', NULL);
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (5, 4, 32000, '2023-09-24 00:00:00', NULL);
INSERT INTO `grant-and-program-tracking`.`GRANT_AWARD` (`grant_award_id`, `funding_organization_id`, `fund_awarded`, `award_date`, `grant_application_id`) VALUES (6, 5, 700000, '2023-10-24 00:00:00', NULL);
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`, `app_deliverable_description`, `app_deliverable_status`, `app_deliverable_planned_completion_date`, `app_deliverable_actual_completion_date`, `grant_application_id`) VALUES (1, 'budget', 'todo', '2020-10-12 00:00:00', '2020-10-06 00:00:00', 1);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`, `app_deliverable_description`, `app_deliverable_status`, `app_deliverable_planned_completion_date`, `app_deliverable_actual_completion_date`, `grant_application_id`) VALUES (2, 'schedule', 'todo', '2020-10-12 00:00:00', '2020-10-06 00:00:00', 1);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`, `app_deliverable_description`, `app_deliverable_status`, `app_deliverable_planned_completion_date`, `app_deliverable_actual_completion_date`, `grant_application_id`) VALUES (3, 'budget', 'todo', '2024-01-10 00:00:00', NULL, 3);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`, `app_deliverable_description`, `app_deliverable_status`, `app_deliverable_planned_completion_date`, `app_deliverable_actual_completion_date`, `grant_application_id`) VALUES (4, 'budget', 'todo', '2023-10-02 00:00:00', '2023-10-06 00:00:00', 6);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_DELIVERABLE` (`app_deliverable_id`, `app_deliverable_description`, `app_deliverable_status`, `app_deliverable_planned_completion_date`, `app_deliverable_actual_completion_date`, `grant_application_id`) VALUES (5, 'schedule', 'todo', '2023-10-02 00:00:00', '2023-10-06 00:00:00', 6);
...
START TRANSACTION;
USE `grant-and-program-tracking`;
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (1, 1);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (1, 2);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (1, 3);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (1, 4);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (2, 1);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (3, 1);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (3, 2);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (4, 2);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (3, 3);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (3, 4);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (1, 6);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (2, 6);
INSERT INTO `grant-and-program-tracking`.`APPLICATION_STAKEHOLDER` (`stakeholder_id`, `grant_application_id`) VALUES (3, 6);
